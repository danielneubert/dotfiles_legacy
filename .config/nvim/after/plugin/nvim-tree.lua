...
require("nvim-tree").setup({
	...
	on_attach = function(treeBuffer)
		...
		remap("<D-e>", api.tree.close, "Close NvimTree")
		remap("<leader>e", api.tree.close, "Close NvimTree")
		remap("q", api.tree.close, "Close NvimTree")
		...
		remap("g?", api.tree.toggle_help, "Show Help")
		remap("gy", api.fs.copy.relative_path, "Copy: Filepath")
